...
def run_rtklib_spp(obs_file: str, nav_file: str, out_file: str):
    """Запускает rnx2rtkp в режиме SPP (Single Point Positioning)."""
    cmd = ["/Users/sergeidolin/RTKLIB/app/consapp/rnx2rtkp/gcc/rnx2rtkp", "-p", "0", "-o", out_file, obs_file, nav_file]
...
def handle_client(conn):
    ...
    try:
        ...
        filename = recv_exactly(conn, name_len).decode('utf-8')
        ...
        run_rtklib_spp(obs_path, eph_path, result_path)
